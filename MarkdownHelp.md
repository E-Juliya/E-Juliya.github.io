#### Первый файл по контролю версий с дополнением по git
...
`git diff`
### **Работа с ветками**
##### Вывести на экран список веток и ветку, где находимся
`git branch`
##### Создать новую ветку с именем
`git branch new_branch_name`
##### Переключиться с одной ветки на другую с именем
`git checkout branch_name`
##### Слить любую ветку с именем с текущей, черновик в чистовик
`git merge branch_name`
##### Удалить ветки с именем
`git branch -d branch_name`
##### Показать список коммитов в виде графа/дерева
`git log --graph`
### **Удалённый репозиторий (pull request на GitHub)**
##### Копировать или клонировать к себе на ПК удалённый репозиторий
`git clone`
##### Скачать всё актуальное из нашего удалённого репозитория и сделать merge
`git pull`
##### Отправить нашу версию репозитория на удалённый репозиторий, требует авторизацию
`git push`
## Списки
